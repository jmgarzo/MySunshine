 ...
 */
package com.jmgarzo.mysunshine.data;
...
//        // Finally, close the cursor and database
    ...
    public void testWeatherTable() {
        long rowLocationID = insertLocation();

        assertFalse("Error: Location Not Inserted Correctly", rowLocationID == -1L);
        ...
        ContentValues weatherValues = TestUtilities.createWeatherValues(rowLocationID);
